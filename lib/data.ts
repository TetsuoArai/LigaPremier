...
export const teams: Team[] = [
  ...
  },
  {
    ...
    players: [
      ...
      { id: "l14", number: 5, name: "Raelth Macario (Becado)", position: "" },
      { id: "l15", number: 6, name: "Naim Manigat (Becado)", position: "" },
      ...
      { id: "l19", number: 10, name: "Ariel Saint Clair (Becado)", position: "" },
      ...
      { id: "l24", number: 15, name: "Douglas Rojas (Becado)", position: "" },
  ...
  },
  {
    ...
    players: [
      ...
      { id: "m3", number: 10, name: "Peterson Francois (Nacional)", position: "" },
      { id: "m4", number: 7, name: "Jenaro Montes (Nacional)", position: "" },
      { id: "m5", number: 15, name: "José Perez", position: "" },
      { id: "m6", number: 6, name: "José Antonio Del Riego (Nacional)", position: "" },
      { id: "m7", number: 28, name: "Gossin Paulny", position: "" },
      { id: "m8", number: 19, name: "Gabriel Torres (Nacional)", position: "" },
      { id: "m9", number: 67, name: "Guillermo Sousa", position: "" },
      { id: "m10", number: 8, name: "Dinio Charles (Nacional)", position: "" },
      { id: "m11", number: 96, name: "Ianfranco Cabral", position: "Portero" },
      { id: "m12", number: 13, name: "Floreal Hedsen (Nacional)", position: "Portero" },
      { id: "m13", number: 42, name: "Erick Reyes", position: "" },
      { id: "m14", number: 11, name: "Junior mansse (Nacional)", position: "" },
    ],
  },
  {
    id: "pelicula",
